...
# Add text annotations for means with symbols
...
# Separate data by doctor
dreamy_randomized_df = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Dreamy']
duck_randomized_df = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Duck']

# Calculate means
dreamy_randomized_mean = dreamy_randomized_df['post_surgical_score'].mean()
duck_randomized_mean = duck_randomized_df['post_surgical_score'].mean()

# Create figure
fig, ax = plt.subplots(figsize=(10, 6))

# Plot scatter points
ax.scatter(dreamy_randomized_df['patient'], dreamy_randomized_df['post_surgical_score'], 
           marker='o', color='#4E79A7', s=60, alpha=0.7, 
           label='Doc Dreamy', zorder=3)
ax.scatter(duck_randomized_df['patient'], duck_randomized_df['post_surgical_score'], 
           marker='^', color='#E15759', s=60, alpha=0.7, 
           label='Doc Duck', zorder=3)

# Add horizontal dashed lines for means
ax.axhline(y=dreamy_randomized_mean, color='#4E79A7', linestyle='--', 
           linewidth=2, alpha=0.8, zorder=2)
ax.axhline(y=duck_randomized_mean, color='#E15759', linestyle='--', 
           linewidth=2, alpha=0.8, zorder=2)

# Add text annotations for means with symbols
ax.text(102, dreamy_randomized_mean, f'○ {dreamy_randomized_mean:.2f}', 
        color='#4E79A7', fontsize=11, fontweight='bold',
        va='center', ha='left', zorder=4)
ax.text(102, duck_randomized_mean, f'△ {duck_randomized_mean:.2f}', 
        color='#E15759', fontsize=11, fontweight='bold',
        va='center', ha='left', zorder=4)
...
# Add text annotations for means (positioned in upper left area)
ax.text(0.02, 0.98, f'○ Doc Dreamy: {dreamy_mean:.2f}', 
        color='#4E79A7', fontsize=11, fontweight='bold',
        transform=ax.transAxes, va='top', ha='left', zorder=4,
